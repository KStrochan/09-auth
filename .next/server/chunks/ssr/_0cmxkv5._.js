...
to {
  ...
  animation: ${V} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,X=({toast:a})=>{let{icon:b,type:c,iconTheme:d}=a;return void 0!==b?"string"==typeof b?e.createElement(W,null,b):b:"blank"===c?null:e.createElement(U,null,e.createElement(P,{...d}),"loading"!==c&&e.createElement(T,null,"error"===c?e.createElement(N,{...d}):e.createElement(S,{...d})))},Y=x("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`];return{animation:b?`${w(e)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${w(f)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}})(a.position||b||"top-center",a.visible):{opacity:0},h=e.createElement(X,{toast:a}),i=e.createElement(Z,{...a.ariaProps},y(a.message,a));return e.createElement(Y,{className:a.className,style:{...g,...d,...a.style}},"function"==typeof f?f({icon:h,message:i}):e.createElement(e.Fragment,null,h,i))}),d=e.createElement,p.p=void 0,t=d,u=void 0,v=void 0,s`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,a.s(["default",0,J],6704)},74870,a=>{a.v({actions:"NoteForm-module__XA_SlW__actions",cancelButton:"NoteForm-module__XA_SlW__cancelButton",error:"NoteForm-module__XA_SlW__error",form:"NoteForm-module__XA_SlW__form",formGroup:"NoteForm-module__XA_SlW__formGroup",input:"NoteForm-module__XA_SlW__input",select:"NoteForm-module__XA_SlW__select",submitButton:"NoteForm-module__XA_SlW__submitButton",textarea:"NoteForm-module__XA_SlW__textarea"})},36429,a=>{"use strict";let b,c;var d=a.i(87924),e=a.i(70025),f=a.i(37927),g=a.i(50944),h=a.i(6704),i=a.i(93505),j=a.i(20226);let k=a=>b=>{try{let c=a(b);if(c instanceof Promise)return c;return{then:a=>k(a)(c),catch(a){return this}}}catch(a){return{then(a){return this},catch:b=>k(b)(a)}}},l={title:"",content:"",tag:"Todo"},m=(0,j.create)()((b=a=>({draft:l,setDraft:b=>a(a=>({draft:{...a.draft,...b}})),clearDraft:()=>a({draft:l})}),c={name:"note-draft",partialize:a=>({draft:a.draft})},(a,d,e)=>{let f,g={storage:function(a){let b;try{b=a()}catch(a){return}return{getItem:a=>{var c;let d=a=>null===a?null:JSON.parse(a,void 0),e=null!=(c=b.getItem(a))?c:null;return e instanceof Promise?e.then(d):d(e)},setItem:(a,c)=>b.setItem(a,JSON.stringify(c,void 0)),removeItem:a=>b.removeItem(a)}}(()=>window.localStorage),partialize:a=>a,version:0,merge:(a,b)=>({...b,...a}),...c},h=!1,i=0,j=new Set,l=new Set,m=g.storage;if(!m)return b((...b)=>{console.warn(`[zustand persist middleware] Unable to update item '${g.name}', the given storage is currently unavailable.`),a(...b)},d,e);let n=()=>{let a=g.partialize({...d()});return m.setItem(g.name,{state:a,version:g.version})},o=e.setState;e.setState=(a,b)=>(o(a,b),n());let p=b((...b)=>(a(...b),n()),d,e);e.getInitialState=()=>p;let q=()=>{var b,c;if(!m)return;let e=++i;h=!1,j.forEach(a=>{var b;return a(null!=(b=d())?b:p)});let o=(null==(c=g.onRehydrateStorage)?void 0:c.call(g,null!=(b=d())?b:p))||void 0;return k(m.getItem.bind(m))(g.name).then(a=>{if(a)if("number"!=typeof a.version||a.version===g.version)return[!1,a.state];else{if(g.migrate){let b=g.migrate(a.state,a.version);return b instanceof Promise?b.then(a=>[!0,a]):[!0,b]}console.error("State loaded from storage couldn't be migrated since no migrate function was provided")}return[!1,void 0]}).then(b=>{var c;if(e!==i)return;let[h,j]=b;if(a(f=g.merge(j,null!=(c=d())?c:p),!0),h)return n()}).then(()=>{e===i&&(null==o||o(d(),void 0),f=d(),h=!0,l.forEach(a=>a(f)))}).catch(a=>{e===i&&(null==o||o(void 0,a))})};return e.persist={setOptions:a=>{g={...g,...a},a.storage&&(m=a.storage)},clearStorage:()=>{null==m||m.removeItem(g.name)},getOptions:()=>g,rehydrate:()=>q(),hasHydrated:()=>h,onHydrate:a=>(j.add(a),()=>{j.delete(a)}),onFinishHydration:a=>(l.add(a),()=>{l.delete(a)})},g.skipHydration||q(),f||p}));var n=a.i(74870);let o=["Todo","Work","Personal","Meeting","Shopping"];a.s(["default",0,function(){let a=(0,g.useRouter)(),b=(0,f.useQueryClient)(),{draft:c,setDraft:j,clearDraft:k}=m(),l=(0,e.useMutation)({mutationFn:i.createNote,onSuccess:()=>{k(),b.invalidateQueries({queryKey:["notes"]}),h.default.success("Note created successfully"),a.push("/notes/filter/all")},onError:()=>{h.default.error("Failed to create note")}});return(0,d.jsxs)("form",{action:a=>{let b;return b={title:a.get("title")?.toString()??"",content:a.get("content")?.toString()??"",tag:a.get("tag")},void l.mutate(b)},className:n.default.form,children:[(0,d.jsxs)("div",{className:n.default.formGroup,children:[(0,d.jsx)("label",{htmlFor:"title",children:"Title"}),(0,d.jsx)("input",{id:"title",name:"title",className:n.default.input,defaultValue:c.title,onChange:a=>j({title:a.target.value})})]}),(0,d.jsxs)("div",{className:n.default.formGroup,children:[(0,d.jsx)("label",{htmlFor:"content",children:"Content"}),(0,d.jsx)("textarea",{id:"content",name:"content",rows:8,className:n.default.textarea,defaultValue:c.content,onChange:a=>j({content:a.target.value})})]}),(0,d.jsxs)("div",{className:n.default.formGroup,children:[(0,d.jsx)("label",{htmlFor:"tag",children:"Tag"}),(0,d.jsx)("select",{id:"tag",name:"tag",className:n.default.select,defaultValue:c.tag,onChange:a=>j({tag:a.target.value}),children:o.map(a=>(0,d.jsx)("option",{value:a,children:a},a))})]}),(0,d.jsxs)("div",{className:n.default.actions,children:[(0,d.jsx)("button",{type:"button",className:n.default.cancelButton,onClick:()=>a.back(),children:"Cancel"}),(0,d.jsx)("button",{type:"submit",className:n.default.submitButton,disabled:l.isPending,children:l.isPending?"Creating...":"Create note"})]})]})}],36429)}];

//# sourceMappingURL=_0cmxkv5._.js.map